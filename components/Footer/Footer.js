    ...
    <div className={`mt-60 mb-60 fade-in ${secFoot ? "" : 'mx-60-var'}`}>
      <div className="textcenter vendor">
        <div className='vendor-div'>
          ...
          <div className='white-button mx-auto cursor-pointer' onClick={alert} style={{ top: 0, padding: '15px' }}>click here</div>
        </div>
      </div>
      {/*  */}
      ...
      <div className='mt-60 mb-60 flex main-grid textcenter soc-media-main-div'>
        ...
        <div onClick={alert} className='grid-center-content soc-media-div hover-pointed-anim cursor-pointer '>
          <div>
      ...
      <div className="hover-pointed-anim main-grid flex email-div mb-30">
        ...
        <div onClick={alert} className='email-div-email flex cursor-pointer'>
          <div>Email</div>
